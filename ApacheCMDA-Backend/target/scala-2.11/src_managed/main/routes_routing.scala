// @SOURCE:/Users/dachengwen/Dropbox/eclipse/SOCProject2/SOC-Fall-2015-Team14-Lead-Xunrong-Li/ApacheCMDA-Backend/conf/routes
// @HASH:89d4a80ed3a2aac8e6bcd5859f70ecc2b782962e
// @DATE:Tue Nov 17 03:15:47 PST 2015
...
// @LINE:79
case controllers_UserController_addFollowee57_route(params) => {
   call(params.fromPath[Long]("followerID", None), params.fromPath[Long]("followeeID", None)) { (followerID, followeeID) =>
        controllers_UserController_addFollowee57_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.UserController]).addFollowee(followerID, followeeID))
   }
}
