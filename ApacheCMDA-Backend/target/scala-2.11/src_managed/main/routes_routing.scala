// @SOURCE:/Users/tonyfu/Documents/workspace/SOC-Fall-2015-Team14-Lead-Xunrong-Li/ApacheCMDA-Backend/conf/routes
// @HASH:0ab8732a008af3837eb15657dcf4b48d96da9564
// @DATE:Sat Nov 14 17:57:12 PST 2015
...
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.PostController]).getPost(fakeValue[Long]),
HandlerDef(this.getClass.getClassLoader, "", "controllers.PostController", "getPost", Seq(classOf[Long]),"GET", """Posts""", Routes.prefix + """posts/postId/$id<[^/]+>"""))
        

// @LINE:50
private[this] lazy val controllers_PostController_getAllPostsByUserId32_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("posts/userId/"),DynamicPart("userId", """[^/]+""",true))))
private[this] lazy val controllers_PostController_getAllPostsByUserId32_invoker = createInvoker(
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.PostController]).getAllPostsByUserId(fakeValue[String]),
HandlerDef(this.getClass.getClassLoader, "", "controllers.PostController", "getAllPostsByUserId", Seq(classOf[String]),"GET", """""", Routes.prefix + """posts/userId/$userId<[^/]+>"""))
...
// @LINE:53
private[this] lazy val controllers_PostController_updatePost35_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("posts/update/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_PostController_updatePost35_invoker = createInvoker(
...
// @LINE:54
private[this] lazy val controllers_PostController_deletePost36_route = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("posts/delete/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_PostController_deletePost36_invoker = createInvoker(
...
case controllers_PostController_getPost31_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_PostController_getPost31_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.PostController]).getPost(id))
   }
}
        

// @LINE:50
case controllers_PostController_getAllPostsByUserId32_route(params) => {
   call(params.fromPath[String]("userId", None)) { (userId) =>
        controllers_PostController_getAllPostsByUserId32_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.PostController]).getAllPostsByUserId(userId))
   }
}
...
// @LINE:53
case controllers_PostController_updatePost35_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_PostController_updatePost35_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.PostController]).updatePost(id))
   }
}
        

// @LINE:54
case controllers_PostController_deletePost36_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_PostController_deletePost36_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.PostController]).deletePost(id))
   }
}
